        ...
        <div className="font-sans text-slate-800 bg-white min-h-screen flex flex-col">
            ...
            <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-white/90 backdrop-blur-md">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xl font-bold text-slate-900 tracking-tight">ByteSetu</span>
                    </div>
                    ...
                    <div className="container mx-auto px-4 py-20 md:py-32 grid md:grid-cols-2 gap-12 items-center">
                        <div className="space-y-6 max-w-2xl relative z-10">
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                                ByteSetu — A Peer-Reviewed platform for Engineers, Scientists, and Innovators.
                            </p>
                    ...
                    <div className="container mx-auto px-4 grid md:grid-cols-12 gap-12">
                         ...
                         <div className="md:col-span-8 space-y-6">
                             ...
                             <p className="text-slate-600 leading-relaxed text-lg">
                                 ByteSetu provides a global platform for researchers, innovators, and scholars to share their research worldwide. We promote advancement in all disciplines, offering high-quality original Research Articles, Review Articles, Case Studies, and Technical Notes.
                             </p>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 relative">
                            ...
                            <div className="text-center space-y-4 bg-white p-6 rounded-xl">
                                ...
                                <p className="text-sm text-slate-600">Download the ByteSetu Paper Template and Review Copyright Form.</p>
            ...
            <footer id="contact" className="bg-slate-900 text-slate-300 py-16">
                <div className="container mx-auto px-4 grid md:grid-cols-4 gap-12 text-sm">
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-white">
                             <BookOpen size={20} />
                             <span className="text-lg font-bold tracking-tight">ByteSetu</span>
                        </div>
                        <p className="text-slate-400 leading-relaxed">
                            ByteSetu: Advancing knowledge since 2016.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <p className="flex items-center gap-2">
                                <Mail size={16} /> editor@bytesetu.com
                            </p>
                            <p>India</p>
                        </div>
                    </div>
                ...
                <div className="container mx-auto px-4 mt-16 pt-8 border-t border-slate-800 text-center text-xs text-slate-500">
                    <p>&copy; {new Date().getFullYear()} ByteSetu. All Rights Reserved. | Designed for Academic Excellence.</p>
                </div>
            </footer>
        </div>
    );
